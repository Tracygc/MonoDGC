...
from .graph_det3d_transformer2_MonoDGC import build_graph_det3d_transformer
...
class MonoDGC(nn.Module):
    """ This is the MonoDGC module that performs monocular 3D object detection """
    ...
    def __init__(self, backbone, depth_predictor, det2d_transformer, det3d_transformer,
        ...
        if with_box_refine:
            ...
            # Inject bbox_embed into 3D decoder so it can build the graph!
    ...
    def forward(self, images, calibs, targets, img_sizes, dn_args=None):
        ...
        # CALL 3D TRANSFORMER (Now internally uses Graph)
...
def build7(cfg):
    ...
    # Use Graph Cross Transformer ---
    det3d_transformer = build_graph_det3d_transformer(cfg)
